...
namespace Cracking.Chapter02
{
    ...
    public class Tests_02_06
    {
        ...
        public void Test()
        {
            ...
            Assert.AreEqual(true, _06.CheckLinkedListPalindromeUsingStack(A));
            Assert.AreEqual(true, _06.CheckLinkedListPalindromeRecursive(A, 6).isPalindrome);
        }
        ...
        public void Test1()
        {
            ...
            Assert.AreEqual(true, _06.CheckLinkedListPalindromeUsingStack(A));
            Assert.AreEqual(true, _06.CheckLinkedListPalindromeRecursive(A, 1).isPalindrome);
        }
        ...
        public void Test2()
        {
            ...
            Assert.AreEqual(true, _06.CheckLinkedListPalindromeUsingStack(A));
            Assert.AreEqual(true, _06.CheckLinkedListPalindromeRecursive(A, 3).isPalindrome);
        }
    }
}
