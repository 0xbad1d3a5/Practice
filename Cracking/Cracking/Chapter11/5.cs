...
namespace Cracking.Chapter11
{
    ...
    public class Tests_11_5
    {
        ...
        public void Test()
        {
            ...
            int result = _5.binarySearchStringSpaces(stringArray, 0, stringArray.Length - 1, "ball");
        ...
        public void Test1()
        {
            ...
            int result = _5.binarySearchStringSpaces(stringArray, 0, stringArray.Length - 1, "at");
