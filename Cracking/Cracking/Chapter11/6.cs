...
namespace Cracking.Chapter11
{
    ...
    public class Tests_11_6
    {
        ...
        public void Test()
        {
            ...
            int[] result = _6.findValueInSortedMatrix(matrix, 0, matrix.GetLength(1) - 1, 6);
            Assert.IsTrue(result.SequenceEqual(new int[] { 1, 1 }));

            result = _6.findValueInSortedMatrix(matrix, 0, matrix.GetLength(1) - 1, 10);
        ...
        public void Test1()
        {
            ...
            int[] result = _6.findValueInSortedMatrix(matrix, 0, matrix.GetLength(1) - 1, 55);
            Assert.IsTrue(result.SequenceEqual(new int[] { 2, 1 }));
        }
        ...
        public void Test2()
        {
            ...
            int[] result = _6.findValueInSortedMatrix(matrix, 0, matrix.GetLength(1) - 1, 0);
        }
    }
}
